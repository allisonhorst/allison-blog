...
I made this little self-tutorial last year because I was **really** excited about being able to more simply customize tables with the [`gt`](https://github.com/rstudio/gt) package by [@rich_iannone](https://twitter.com/riannone).
