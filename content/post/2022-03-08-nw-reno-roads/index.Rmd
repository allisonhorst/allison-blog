...
- `osmdata`: Mark Padgham, Bob Rudis, Robin Lovelace, Maëlle Salmon (2017). osmdata Journal of Open Source Software, 2(14).
...
```{r}
knitr::include_graphics(here::here("content", "post", "2022-03-08-nw-reno-roads", "featured_nw_reno.png"))
```
