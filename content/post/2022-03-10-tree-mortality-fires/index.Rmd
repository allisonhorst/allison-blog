...
```{r, echo = FALSE}
ggsave(here::here("content", "post", "2022-03-10-tree-mortality-fires", "trees_20_gg.png"), width = 5,height = 6)
```

```{r, echo = FALSE}
knitr::include_graphics(here::here("content", "post", "2022-03-10-tree-mortality-fires", "trees_20_gg.png"))
```
...
```{r, echo = FALSE}
ggsave(here::here("content", "post", "2022-03-10-tree-mortality-fires", "tree_survival_gg.png"), width = 8,height = 8)
```

```{r, echo = FALSE}
knitr::include_graphics(here::here("content", "post", "2022-03-10-tree-mortality-fires", "tree_survival_gg.png"))
```
...
```{r, echo = FALSE}
ggsave(plot = survival_gg, here::here("content", "post", "2022-03-10-tree-mortality-fires", "ponderosa_survival_gg.png"), width = 8,height = 6)
```

```{r, echo = FALSE}
knitr::include_graphics(here::here("content", "post", "2022-03-10-tree-mortality-fires", "ponderosa_survival_gg.png"))
```
...
```{r, echo = FALSE}
ggsave(plot = ponderosa_prob_alive, here::here("content", "post", "2022-03-10-tree-mortality-fires", "ponderosa_prob_gg.png"), width = 6,height = 6)
```

```{r, echo = FALSE}
knitr::include_graphics(here::here("content", "post", "2022-03-10-tree-mortality-fires", "ponderosa_prob_gg.png"))
```
...
```{r, echo = FALSE}
ggsave(plot = all_prob_gg, here::here("content", "post", "2022-03-10-tree-mortality-fires", "all_prob_gg.png"), width = 6,height = 6)
```

```{r, echo = FALSE}
knitr::include_graphics(here::here("content", "post", "2022-03-10-tree-mortality-fires", "all_prob_gg.png"))
```
